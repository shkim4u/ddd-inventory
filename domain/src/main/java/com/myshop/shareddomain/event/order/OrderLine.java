...
public class OrderLine extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3100548126410602501L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderLine\",\"namespace\":\"com.myshop.shareddomain.event.order\",\"fields\":[{\"name\":\"productId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"quantity\",\"type\":\"int\"},{\"name\":\"price\",\"type\":\"int\"}]}");
   ...
   */
  public OrderLine(java.lang.String productId, java.lang.Integer quantity, java.lang.Integer price) {
   ...
   */
  public static com.myshop.shareddomain.event.order.OrderLine.Builder newBuilder() {
    return new com.myshop.shareddomain.event.order.OrderLine.Builder();
  }
   ...
   * @return A new OrderLine RecordBuilder
   */
  public static com.myshop.shareddomain.event.order.OrderLine.Builder newBuilder(com.myshop.shareddomain.event.order.OrderLine.Builder other) {
    if (other == null) {
      return new com.myshop.shareddomain.event.order.OrderLine.Builder();
    } else {
      return new com.myshop.shareddomain.event.order.OrderLine.Builder(other);
    }
  }
   ...
   * @return A new OrderLine RecordBuilder
   */
  public static com.myshop.shareddomain.event.order.OrderLine.Builder newBuilder(com.myshop.shareddomain.event.order.OrderLine other) {
    if (other == null) {
      return new com.myshop.shareddomain.event.order.OrderLine.Builder();
    } else {
      return new com.myshop.shareddomain.event.order.OrderLine.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderLine>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.myshop.shareddomain.event.order.OrderLine.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.myshop.shareddomain.event.order.OrderLine other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.productId)) {
        this.productId = data().deepCopy(fields()[0].schema(), other.productId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.myshop.shareddomain.event.order.OrderLine.Builder setProductId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.myshop.shareddomain.event.order.OrderLine.Builder clearProductId() {
      productId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.myshop.shareddomain.event.order.OrderLine.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.myshop.shareddomain.event.order.OrderLine.Builder clearQuantity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.myshop.shareddomain.event.order.OrderLine.Builder setPrice(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.myshop.shareddomain.event.order.OrderLine.Builder clearPrice() {
